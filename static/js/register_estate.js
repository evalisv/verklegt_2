...
function addClassNamesToLabels() {
    ...
    $('label[for="id_type"], label[for="id_year_built"]')
        .addClass('form-group-4 col-sm-3');
...
function manipulateHtml() {
    $('.form-group-1').wrapAll('<div class="row" />');
    $('.form-group-2').wrapAll('<div class="row" />');
    $('.form-group-3').wrapAll('<div class="row" />');
    $('.form-group-4').wrapAll('<div class="row" />');
    $('.form-group-5').wrapAll('<div class="row" />');
    $('.form-group-6').wrapAll('<div class="row" />');
}