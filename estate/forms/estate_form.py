...
class UpdateEstateForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "images": widgets.ClearableFileInput(attrs={"multiple": True, "class": "col-sm-3 images form-group-7", "accept": "image/*"}),
            "open_house": widgets.DateTimeInput(attrs={"class": "col-sm-10 open_house datetimepicker-input form-group-7", "data-target": "#id_open_house"})
        }
        labels = {
